...
def main(publish=False):
    ...
    for event in gh_events:
        ...
        activities.append({"id":f"github-{event.get('id')}","date":stamp[:10],"time":stamp[11:16],"area":"desarrollo","source":"GitHub","person":person,"client":"Interno","project":repo,"title":f"{event.get('type','Actividad')} en {repo}","description":"Actividad técnica registrada en GitHub; contenido omitido en la vista pública."})
